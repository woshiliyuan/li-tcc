...
public class DateUtils {
	...
	/**
	 * 把字符串转成日期类型. 输入的日期格式:yyyy-MM-dd HH:mm:ss
	 * 
	 * @param str
	 * @return
	...
	/**
	 * 把字符串转成特定格式的日期类型. 输入的日期格式:yyyy-MM-dd HH:mm:ss
	 * 
	 * @param str
	 * @param dateFormat
	 * @return
	...
	/**
	 * yyyy-MM-dd HH:mm:ss. 时间点转换成日期字符串
	 * 
	 * @param instant
	 * @return
	 * @throws ParseException
	...
	/**
	 * yyyy-MM-dd HH:mm:ss,得到day的起始时间点. 一天开始的时间为　0:0:0
	 * 
	 * @param date
	 * @return
	 */
	...
	/**
	 * yyyy-MM-dd HH:mm:ss,得到day的结束时间点。. 一天结束的时间为 23:59:59
	 * 
	 * @param date
	 * @return
	 */
	...
	/**
	 * 得到传入日期,周起始时间. 这个方法定义:周一为一个星期开始的第一天
	 *
	 * @param date
	 * @return 返回一周的第一天
	 */
	...
	/**
	 * 得到当前周截止时间. 这个方法定义:周日为一个星期开始的最后一天
	 *
	 * @param date
	 * @return 返回一周的最后一天
	 */
	...
	/*
	 * public static void main(String[] args) throws Exception { LocalDateTime
	 * t1 = LocalDateTime.now(); LocalDateTime t2 =
	 * LocalDateTime.now().plusDays(1); System.out.println(t1.isAfter(t2));
